...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Training', fields ['resource_id']
        db.create_index('website_training', ['resource_id'])


    def backwards(self, orm):
        # Removing index on 'Training', fields ['resource_id']
        db.delete_index('website_training', ['resource_id'])
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 0, 0)'}),
