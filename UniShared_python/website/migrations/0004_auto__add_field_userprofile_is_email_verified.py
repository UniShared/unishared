...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_email_verified'
        db.add_column('website_userprofile', 'is_email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_email_verified'
        db.delete_column('website_userprofile', 'is_email_verified')
