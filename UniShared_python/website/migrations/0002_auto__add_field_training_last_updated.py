...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Training.last_updated'
        db.add_column('website_training', 'last_updated',
                      self.gf('django.db.models.fields.IntegerField')(default=1327217400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Training.last_updated'
        db.delete_column('website_training', 'last_updated')
