...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainingTempShare.role'
        db.add_column('website_trainingtempshare', 'role',
                      self.gf('django.db.models.fields.CharField')(default='cowriters', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainingTempShare.role'
        db.delete_column('website_trainingtempshare', 'role')
