...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoteTakingBuddy'
        db.create_table('website_notetakingbuddy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hub', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Hub'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('note_taking_format', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('passionated_by_subject', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augmented_documents', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('behavior', self.gf('django.db.models.fields.CharField')(max_length=22)),
            ('live_session', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('website', ['NoteTakingBuddy'])

        # Adding unique constraint on 'NoteTakingBuddy', fields ['hub', 'user']
        db.create_unique('website_notetakingbuddy', ['hub_id', 'user_id'])

        # Deleting field 'TrainingTempShare.user'
        db.delete_column('website_trainingtempshare', 'user_id')

        # Adding field 'TrainingTempShare.user_who_invites'
        db.add_column('website_trainingtempshare', 'user_who_invites',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_who_invites', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TrainingTempShare.user_invited'
        db.add_column('website_trainingtempshare', 'user_invited',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_invited', null=True, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'NoteTakingBuddy', fields ['hub', 'user']
        db.delete_unique('website_notetakingbuddy', ['hub_id', 'user_id'])

        # Deleting model 'NoteTakingBuddy'
        db.delete_table('website_notetakingbuddy')
        ...
        # Deleting field 'TrainingTempShare.user_who_invites'
        db.delete_column('website_trainingtempshare', 'user_who_invites_id')

        # Deleting field 'TrainingTempShare.user_invited'
        db.delete_column('website_trainingtempshare', 'user_invited_id')
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
