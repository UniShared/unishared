...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Training', fields ['title']
        db.create_index('website_training', ['title'])


    def backwards(self, orm):
        # Removing index on 'Training', fields ['title']
        db.delete_index('website_training', ['title'])
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)'}),
