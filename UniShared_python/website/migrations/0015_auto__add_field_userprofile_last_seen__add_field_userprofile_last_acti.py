...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_userprofile', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.last_activity_ip'
        db.add_column('website_userprofile', 'last_activity_ip',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('website_userprofile', 'last_seen')

        # Deleting field 'UserProfile.last_activity_ip'
        db.delete_column('website_userprofile', 'last_activity_ip')
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 0, 0)'}),
