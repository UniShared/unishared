...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.enable_notifications'
        db.add_column('website_userprofile', 'enable_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.enable_notifications'
        db.delete_column('website_userprofile', 'enable_notifications')
