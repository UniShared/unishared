...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainingTempShare.last_updated'
        db.add_column('website_trainingtempshare', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 22, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainingTempShare.last_updated'
        db.delete_column('website_trainingtempshare', 'last_updated')
