...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Training.total_views_open25'
        db.add_column('website_training', 'total_views_open25',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Training.total_views_open25'
        db.delete_column('website_training', 'total_views_open25')
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 27, 0, 0)'}),
