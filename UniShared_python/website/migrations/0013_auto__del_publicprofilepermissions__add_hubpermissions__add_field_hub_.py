...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HubPermissions'
        db.create_table('website_hubpermissions', (
            ('hub', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hub', primary_key=True, to=orm['website.Hub'])),
            ('allowed_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='allowed_user', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('website', ['HubPermissions'])

        # Adding field 'Hub.moderator'
        db.add_column('website_hub', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderator', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HubPermissions'
        db.delete_table('website_hubpermissions')

        # Deleting field 'Hub.moderator'
        db.delete_column('website_hub', 'moderator_id')
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
