...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrainingSchedule.is_scheduled'
        db.delete_column('website_trainingschedule', 'is_scheduled')

        # Adding field 'TrainingSchedule.event_id'
        db.add_column('website_trainingschedule', 'event_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TrainingSchedule.is_scheduled'
        db.add_column('website_trainingschedule', 'is_scheduled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TrainingSchedule.event_id'
        db.delete_column('website_trainingschedule', 'event_id')
    ...
    models = {
        ...
        'website.trainingtempshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
